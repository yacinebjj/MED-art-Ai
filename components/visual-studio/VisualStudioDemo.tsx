    ...
    <div className="relative flex h-[80vh] min-h-[600px] w-full flex-col justify-between overflow-hidden rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="relative z-10 m-8 max-h-[75vh] w-[42%] overflow-y-auto rounded-3xl border border-white/15 bg-slate-900/80 p-8 text-slate-100 shadow-2xl backdrop-blur-2xl"
        >
        ...
        <div className="flex items-center gap-1.5 px-3">
          {slides.map((slide, idx) => (
            <button
              ...
              aria-label={`Aller à la diapositive ${slide.id}`}
