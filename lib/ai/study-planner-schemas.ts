...
/** A rest day is simply OMITTED from `days` entirely — every date present here has real work on it. */
...
export const StudyPlanGenerationSchema = z
  .object({
...
export const StudyPlanRefinementSchema = z
  .object({
